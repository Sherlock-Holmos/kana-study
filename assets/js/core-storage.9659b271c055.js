import { DEVICE_ID_KEY, LEGACY_STORAGE_KEYS, STORAGE_KEY, USER_STORAGE_PREFIX } from "./core-constants.f0296b234e4d.js";
...
export function exportStateFile(state) {
  ...
  a.href = url;
  a.download = `japanese-study-v16-${new Date().toISOString().slice(0, 10)}.json`;
