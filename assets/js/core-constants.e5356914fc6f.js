...
export const CONTENT_RELEASE = "n5-2026.08-v15";
...
export const MAX_SESSION_HISTORY = 240;

export const VIEW_NAMES = ["home", "learn", "study", "review", "library", "progress"];

export const ITEM_TYPES = {
  KANA: "kana", VOCABULARY: "vocabulary", GRAMMAR: "grammar", KANJI: "kanji",
  SENTENCE: "sentence", READING: "reading", LISTENING: "listening"
};

export const TYPE_LABELS = {
  kana: "假名", vocabulary: "词汇", grammar: "语法", kanji: "汉字",
  sentence: "例句", reading: "阅读", listening: "听力"
};

export const SKILL_LABELS = {
  recognition: "识别", recall: "主动回忆", meaning: "理解词义", reading: "读音",
  production: "中 → 日", application: "应用", comprehension: "理解"
};
