import { CLOUD_SYNC_DELAY_MS, MAX_SESSION_HISTORY, TYPE_LABELS, VIEW_NAMES } from "./core-constants.f0296b234e4d.js";
import { createAssessmentSession, updateDiagnosticState } from "./assessment-engine.536ea1564f84.js";
import { createDefaultState, sanitizeState } from "./core-state.eb7a969a6233.js";
import { exportStateFile, getDeviceId, loadLocalState, removeGuestState, saveLocalState } from "./core-storage.9659b271c055.js";
...
import { skillKey } from "./domain-skills.fac520b144fa.js";
import { buildExercise, isExerciseAnswerCorrect } from "./learning-exercises.54d284966f30.js";
import { getAnswerEvidence } from "./learning-evidence.02abc8e807a7.js";
import { applyPlanSnapshot, buildDailyPlan } from "./learning-planner.c7bf002a9751.js";
import { updateSkillAfterAnswer } from "./learning-srs.7012747feb1a.js";
import { advanceSimpleEntry, createDailySession, createItemSession, createLessonSession, createReviewSession, getCurrentEntry, recordQuizResult, recordSpeakingResult, summarizeSession } from "./learning-session.114e86581491.js";
import { getDuePairs, getRecentMistakePairs, getSlowPairs, getWeakPairs } from "./review-selectors.e65fcdbbcf1e.js";
import { mergeStates } from "./sync-merge.2e59aea3eded.js";
import { getCurrentUser, loadCloudProgress, onAuthStateChange, saveCloudProgress, sendPasswordReset, signIn, signOut, signUp, updatePassword } from "./sync-supabase.c6e84dae622e.js";
import { markDateDirty, markSessionDirty, markSkillDirty, clearDirtyState } from "./sync-dirty-tracker.75c38edc3fa5.js";
import { playLearningAudio } from "./audio-player.6a663d9b8027.js";
import { disposeSpeakingPlayback, startSpeakingRecording, stopSpeakingRecording, supportsSpeakingRecording } from "./speaking-recorder.321c3e597dc5.js";
import { renderHome, bindHome } from "./views-home.694196da7d0a.js";
import { renderLearn, bindLearn } from "./views-learn.4d5acbf8171e.js";
import { renderStudy, bindStudy } from "./views-study.398eb1a19f8c.js";
import { renderReview, bindReview } from "./views-review.d093e77243dc.js";
import { renderLibrary, bindLibrary } from "./views-library.e38b7fc495c8.js";
import { renderProgress, bindProgress } from "./views-progress.7739d02d1c8a.js";
import { renderModal, bindModal } from "./ui-modals.ebbfb0f0ed83.js";
