import { CLOUD_SYNC_DELAY_MS, MAX_SESSION_HISTORY, TYPE_LABELS, VIEW_NAMES } from "./core-constants.e5356914fc6f.js";
import { createAssessmentSession, updateDiagnosticState } from "./assessment-engine.9f58416f0021.js";
import { createDefaultState, sanitizeState } from "./core-state.4badd8d14e01.js";
import { exportStateFile, getDeviceId, loadLocalState, removeGuestState, saveLocalState } from "./core-storage.6c1a0aac3550.js";
import { localDateKey, nowIso } from "./core-utils.8125d8a6489d.js";
import { getLearningItem } from "./data-content.c2d48fc96319.js";
import { LESSON_BY_ID } from "./data-curriculum.9d44927613fd.js";
import { skillKey } from "./domain-skills.cf531db05ff8.js";
import { buildExercise, isExerciseAnswerCorrect } from "./learning-exercises.8267ead6ba9f.js";
import { getAnswerEvidence } from "./learning-evidence.02abc8e807a7.js";
import { applyPlanSnapshot, buildDailyPlan } from "./learning-planner.8604b6639fe3.js";
import { updateSkillAfterAnswer } from "./learning-srs.51443710bb7b.js";
import { advanceSimpleEntry, createDailySession, createItemSession, createLessonSession, createReviewSession, getCurrentEntry, recordQuizResult, summarizeSession } from "./learning-session.b169d67cf6aa.js";
import { getDuePairs, getRecentMistakePairs, getSlowPairs, getWeakPairs } from "./review-selectors.ec1a8b090fb3.js";
import { mergeStates } from "./sync-merge.da7f685371bf.js";
import { getCurrentUser, loadCloudProgress, onAuthStateChange, saveCloudProgress, sendPasswordReset, signIn, signOut, signUp, updatePassword } from "./sync-supabase.b8bf87a82435.js";
import { markDateDirty, markSessionDirty, markSkillDirty, clearDirtyState } from "./sync-dirty-tracker.75c38edc3fa5.js";
import { playLearningAudio } from "./audio-player.0e37a620ec99.js";
import { renderHome, bindHome } from "./views-home.dab8c1dd0947.js";
import { renderLearn, bindLearn } from "./views-learn.30b4fd78b0c4.js";
import { renderStudy, bindStudy } from "./views-study.cbe0bb9936fd.js";
import { renderReview, bindReview } from "./views-review.423ebaa46f17.js";
import { renderLibrary, bindLibrary } from "./views-library.44fa58802388.js";
import { renderProgress, bindProgress } from "./views-progress.afc9b25d8117.js";
import { renderModal, bindModal } from "./ui-modals.113e6d47d791.js";
