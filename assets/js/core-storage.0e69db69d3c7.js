import { DEVICE_ID_KEY, LEGACY_STORAGE_KEYS, STORAGE_KEY, USER_STORAGE_PREFIX } from "./core-constants.4ada7fdea3dc.js";
import { createDefaultState, sanitizeState } from "./core-state.41316c0191c0.js";
import { randomId } from "./core-utils.adc6ebb0fb19.js";
...
export function exportStateFile(state) {
  ...
  a.href = url;
  a.download = `japanese-study-v14-${new Date().toISOString().slice(0, 10)}.json`;
