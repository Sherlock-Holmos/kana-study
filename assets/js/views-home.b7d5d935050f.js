import { getCurrentStreak, getN5Completion, getTodaySummary, getTypeProgress } from "./core-metrics.8c86860b0477.js";
import { PROGRESS_DOMAIN_TYPES, TYPE_LABELS } from "./core-constants.4ada7fdea3dc.js";
import { buildDailyPlan, DAILY_PLAN_MODES, formatPlanBreakdown } from "./learning-planner.250bfde3d520.js";
...
export function renderHome(state) {
  ...
  return `
    <section class="hero panel daily-hero">
      <div>
        <span class="eyebrow">Japanese Study v14 · N5 今日计划</span>
        <h1>今天学什么，系统已经排好了</h1>
    ...
    <section class="panel section-block n5-completion-card">
      ...
      <p class="muted-copy">这是站内学习完成度，不等同于 JLPT 官方成绩预测；它由六大学习域掌握度和课程完成度共同计算。阶段测验独立记录，不直接抬高或降低这个掌握度。</p><div class="chip-actions"><button type="button" data-route="learn">阶段测验与诊断</button></div>
    </section>
