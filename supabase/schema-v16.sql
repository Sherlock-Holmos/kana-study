-- Japanese Study v16 optional profile extension.
-- Core normalized tables from schema-v12 remain compatible.
-- v16 frontend stores Planner / Ability / Assessment / Speaking / Sync metadata in user_learning_meta.meta.v16.
...
create table if not exists public.user_learning_profiles (
  ...
  speaking_state jsonb not null default '{}'::jsonb,
...
create policy "users write own learning profile"
